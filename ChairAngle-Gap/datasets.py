...
class DatasetTrain(torch.utils.data.Dataset):
    def __init__(self):
        with open("/root/regression_uncertainty/ChairAngle-Gap/labels_train.pkl", "rb") as file: # (needed for python3)
            self.labels = pickle.load(file)
        with open("/root/regression_uncertainty/ChairAngle-Gap/images_train.pkl", "rb") as file: # (needed for python3)
...
class DatasetVal(torch.utils.data.Dataset):
    def __init__(self):
        with open("/root/regression_uncertainty/ChairAngle-Gap/labels_val.pkl", "rb") as file: # (needed for python3)
            self.labels = pickle.load(file)
        with open("/root/regression_uncertainty/ChairAngle-Gap/images_val.pkl", "rb") as file: # (needed for python3)
            self.imgs = pickle.load(file)
...
class DatasetTest(torch.utils.data.Dataset):
    def __init__(self):
        with open("/root/regression_uncertainty/ChairAngle-Gap/labels_test.pkl", "rb") as file: # (needed for python3)
            self.labels = pickle.load(file)
        with open("/root/regression_uncertainty/ChairAngle-Gap/images_test.pkl", "rb") as file: # (needed for python3)
            self.imgs = pickle.load(file)
