...
for run_i in range(num_runs):
    ...
    for i in range(M):
        ...
        network = GaussNet(model_id + "_eval_gaussian_ensemble_selective_ensemble_variance", project_dir="/root/regression_uncertainty/ChairAngle").cuda()
        network.load_state_dict(torch.load("/root/regression_uncertainty/ChairAngle/training_logs/model_%s_%d/checkpoints/model_%s_epoch_%d.pth" % (model_id, model_i, model_id, epoch)))
