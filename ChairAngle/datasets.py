...
#
# with open("/root/regression_uncertainty/ChairAngle/labels_train.pkl", "wb") as file:
#     pickle.dump(labels_train, file)
# with open("/root/regression_uncertainty/ChairAngle/images_train.pkl", "wb") as file:
#     pickle.dump(images_train, file)
#
# with open("/root/regression_uncertainty/ChairAngle/labels_val.pkl", "wb") as file:
#     pickle.dump(labels_val, file)
# with open("/root/regression_uncertainty/ChairAngle/images_val.pkl", "wb") as file:
#     pickle.dump(images_val, file)
#
# with open("/root/regression_uncertainty/ChairAngle/labels_test.pkl", "wb") as file:
#     pickle.dump(labels_test, file)
# with open("/root/regression_uncertainty/ChairAngle/images_test.pkl", "wb") as file:
#     pickle.dump(images_test, file)
# ################################################################################

class DatasetTrain(torch.utils.data.Dataset):
    def __init__(self):
        with open("/root/regression_uncertainty/ChairAngle/labels_train.pkl", "rb") as file: # (needed for python3)
            self.labels = pickle.load(file)
        with open("/root/regression_uncertainty/ChairAngle/images_train.pkl", "rb") as file: # (needed for python3)
...
class DatasetVal(torch.utils.data.Dataset):
    def __init__(self):
        with open("/root/regression_uncertainty/ChairAngle/labels_val.pkl", "rb") as file: # (needed for python3)
            self.labels = pickle.load(file)
        with open("/root/regression_uncertainty/ChairAngle/images_val.pkl", "rb") as file: # (needed for python3)
            self.imgs = pickle.load(file)
...
class DatasetTest(torch.utils.data.Dataset):
    def __init__(self):
        with open("/root/regression_uncertainty/ChairAngle/labels_test.pkl", "rb") as file: # (needed for python3)
            self.labels = pickle.load(file)
        with open("/root/regression_uncertainty/ChairAngle/images_test.pkl", "rb") as file: # (needed for python3)
            self.imgs = pickle.load(file)
